...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  /***/
  function srcAppActivitiesServicesSharedServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var SharedService = /*#__PURE__*/function () {
      ...
      _createClass(SharedService, [{
        key: "getActivitiesData",
        value: function getActivitiesData() {
          return _toConsumableArray(this.expenses);
        }
      }, {
        key: "addNewActivities",
        value: function addNewActivities(activities) {
